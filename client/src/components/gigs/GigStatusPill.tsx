import { CheckCircle2, Loader2, AlertTriangle, Clock, CircleDot } from "lucide-react";
import { cn } from "@/lib/utils";
import type { GigStatus } from "@/types/gigs";
...
const META: Record<GigStatus, { label: string; icon: React.ComponentType<{ className?: string }>; classes: string }> = {
  ...
  partial: { label: "Partial", icon: CircleDot, classes: "bg-amber-100 text-amber-700" },
...
export function GigStatusPill({ status, className }: Props) {
