      ...
      <div className="w-full">
        <div className="mx-auto">
          <svg
            ...
            className="not-found-svg block h-auto w-full"
          >
            ...
            <g id="not_found_tracks">
              {[
                9.8, 19.8, 29.8, 39.8, 49.8, 59.8, 69.8, 79.8, 89.8, 99.8, 109.8, 119.8, 129.8,
                139.8, 149.8, 159.8, 169.8, 179.8, 189.8, 199.8, 209.8, 219.8, 229.8, 239.8, 249.8,
                259.8, 269.8, 279.8, 289.8, 299.8, 309.8, 319.8, 329.8, 339.8, 349.8, 359.8, 369.8,
                379.8, 389.8, 399.8, 409.8, 419.8, 429.8, 439.8, 449.8, 459.8, 469.8, 479.8, 489.8,
                499.8,
              ].map((x) => (
                <path key={`track-left-${x}`} className="not_found_st2" d={`M${x} 282.4h-3L${x - 9.8} 307.6h3z`} />
              ))}
              {[
                ...
                <path key={`track-right-${x}`} className="not_found_st2" d={`M${x} 282.4h-3l-6.8 25.2h3z`} />
              ))}
              <g>
                {[
                  -490.2, -480.2, -470.2, -460.2, -450.2, -440.2, -430.2, -420.2, -410.2, -400.2,
                  -390.2, -380.2, -370.2, -360.2, -350.2, -340.2, -330.2, -320.2, -310.2, -300.2,
                  -290.2, -280.2, -270.2, -260.2, -250.2, -240.2, -230.2, -220.2, -210.2, -200.2,
                  -190.2, -180.2, -170.2, -160.2, -150.2, -140.2, -130.2, -120.2, -110.2, -100.2,
                  -90.2, -80.2, -70.2, -60.2, -50.2, -40.2, -30.2, -20.2, -10.2, -0.2, 500, 490,
                  480, 470, 460, 450, 440, 430, 420, 410, 400, 390, 380, 370, 360, 350, 340, 330,
                  320, 310, 300, 290, 280, 270, 260, 250, 240, 230, 220, 210, 200, 190, 180, 170,
                  160, 150, 140, 130, 120, 110, 100, 90, 80, 70, 60,
                ].map((x) => (
                  <path key={`track-mid-${x}`} className="not_found_st2" d={`M${x} 282.4h-3l-6.8 25.2h3z`} />
                ))}
              </g>
              {[550, 540, 530, 520, 510, 550, 540, 530, 520, 510].map((x, index) => (
                <path key={`track-tail-${x}-${index}`} className="not_found_st2" d={`M${x} 282.4h-3l-6.8 25.2h3z`} />
              ))}
            ...
            <g id="not_found_train">
              ...
              <g id="not_found_wheels">
                {[
                  ...
                  <g key={cx}>
                    <circle className="not_found_st6" cx={cx} cy="285.6" r={r} />
                    <path
