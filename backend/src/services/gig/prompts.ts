...
export function buildGigCorePrompt(input: GigInput): GigPromptBundle {
  ...
  "portfolioSampleIdeas": ["string"]
    ...
    "3. TAGS & KEYWORDS: Provide between 5 and 8 tags AND between 5 and 8 SEO keywords. Every item in the tags array must be exactly 2 to 3 lowercase words, containing alphanumeric characters and spaces only. No special characters or single-word tags. SEO keywords should be distinct, search-relevant phrases.",
